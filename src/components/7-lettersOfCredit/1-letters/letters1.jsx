                                            ...
                                            <div className="p-6">
                                                ...
                                                <div className="overflow-x-auto bg-gray-100 p-4 rounded-lg shadow-md">
                                                    <table className="min-w-full rounded-md bg-white">
                                                        ...
                                                        <tbody className="bg-gray-100">
                                                            {[...Array(5)].map((_, index) => (
                                                                <tr key={index} className="bg-white border-b border-gray-200 flex flex-col md:table-row md:flex-row space-y-4 md:space-y-0 mb-6">
                                                                    <td className="py-1 px-1 text-center w-100 md:w-10 flex items-center md:justify-center">
