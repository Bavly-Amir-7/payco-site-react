                ...
                <div className="mainVerf">
                    ...
                    <div className="relative mb-6">
                        <div className="absolute inset-0 flex items-center">
                            <div className="w-full borderInput-t borderInput-gray-300"></div>
                        </div>
                        ...
                        <div className="bg-white p-8 rounded-lg shadow-md">
                            ...
                            <div>
                                ...
                                <div className="grid  gap-1 mb-4">
                                    ...
                                    <div className='d-flex mail '>
                                        <div className="mailArea labelStyles iconGap flex items-center borderInput rounded p-2">
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <button className="verfBtn  bg-gray-200 text-gray-700 px-4 py-2 rounded">Verify</button>
                                    </div>
                                </div>
                                <div className="grid  gap-1 mb-4">
                                    ...
                                    <div className='d-flex  '>
                                        ...
                                        <div className="phoneNumber iconGap flex items-center borderInput rounded p-2">
                                            ...
                                            </i>                                            <input type="text" className=" outline-none" placeholder="(+44)" />
                                        </div>
                                        <div className="theNumber flex items-center borderInput rounded p-2" style={{ marginLeft: "8px" }}>
                                            <input type="text" className="flex-1 outline-none" placeholder="(+44) 123123456" />
                                        </div>
                                        <button className="verfBtn  bg-gray-200 text-gray-700 px-4 py-2 rounded" style={{ marginLeft: "24px" }}>Verify</button>
                                    </div>
                                </div>
                            ...
                            <div className="flex justify-center">
                                <button className="save greyBtn greyBg text-white font-semibold px-4 py-2 rounded-lg hover:bg-red-600" onClick={handleSave}>Save & Next</button>
                            </div>
                        </div>
