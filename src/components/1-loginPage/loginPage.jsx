                            ...
                            <form>
                                <div className="mb-4">
                                    ...
                                    <div className="iconArea flex items-center border border-gray-300 rounded">
                                        <i className="p-2"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clipPath="url(#clip0_3831_7410)">
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="iconArea flex items-center border border-gray-300 rounded">
                                        <i className="p-2"><svg width="8" height="16" viewBox="0 0 8 16" fill="none" xmlns="http://www.w3.org/2000/svg">
