// this is next.jsx code  component name is 1-loginPage
      ...
      <div className="loginBody">
        ...
        <div className="bg-gray-100 min-h-screen flex loginArea ">
          <div className="w-1/2 imageParent bg-white flex items-center justify-center relative computer">
            <img src={image1} alt="Illustration of security and payment elements" style={{ width: "500px", height: '300px' }} />
            ...
            <div className="w-3/4 imageChild">
              <div className="text-center mb-8">
                <div className="word flex flex-row items-center">
                  <img src={image2} alt="Description of the image" style={{width:"270",height:"95px"}} />
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <div className="text-right mt-1">
                    <a className="text-sm  hover:text-gray-700" href="#" style={{ color: "#6358DC" }}>
                      Forgot Password?
                    </a>
                  </div>
                </div>
                ...
                <div>
                  <button
                    className="w-full redBg py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                    type="submit"
                  >
                    Login
                  </button>
