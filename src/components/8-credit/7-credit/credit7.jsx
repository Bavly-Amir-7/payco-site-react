                        ...
                        <div className="bg-gray-100 flex justify-center items-center w-100">
                            ...
                            <div className="bg-white p-6 rounded-lg  w-100 ">
                                ...
                                <div className=" flex items-center justify-center">
                                    <div className="w-100">
                                        {/* Approved Item */}
                                        <div className="greyBg2 p-4 rounded-lg  mb-4 flex items-center">
                                            <i className="fas fa-check-circle text-green-500 text-2xl mr-4"></i>
                                            <div className="flex-1 text-start">
                                                <div className="text-lg font-semibold">Beneficiary's Signed Commercial Invoice</div>
                                        ...
                                        <div className="greyBg2 p-4 rounded-lg  mb-4">
                                            <div className="flex items-center mb-2">
                                                <i className="fas fa-times-circle text-red-500 text-2xl mr-4"></i>
                                                <div className="flex-1 text-start" >
                                                    <div className="text-lg font-semibold">Beneficiary's Signed Commercial Invoice</div>
                                                    <div className="text-sm text-gray-500">Reason of rejection : Doesn't match</div>
                                                </div>
                                                <button className="bg-red-500 text-white px-4 py-2 rounded">Replace</button>
                                            </div>
                                            <div className="flex items-center mb-2 w-100">
                                                <div className="flex w-100 justify-between">

                                                    <img src="https://placehold.co/50x50" alt="National ID" className="w-12 h-12 mr-4" />
