...
export default function Business12() {
    ...
    const [beneficialOwners, setBeneficialOwners] = useState([
        "Business Account      Robert Brown",
        "Personal Account      Sarah Johnson",
        "Investment Account      Michael Lee",
        "Trust Account      Emily Davis"
    ]);
            ...
            <div className="container-fluid">
                <div className="row">
                    ...
                    <div className="col-12 col-lg-9 col-md-10 mt-5" style={{ placeItems: "center" }}>
                        ...
                        <div className="relative mb-6 w-100 mt-6">
                                ...
                                <div className="border rounded-lg p-4">
                                    <div className="flex justify-between items-center" onClick={toggleCountries} style={{ cursor: "pointer" }}>
                                        <div className="flex items-center">
                                            ...
                                            <span className="font-semibold">Assets Details</span>
                                        </div>
                                    ...
                                    {isBeneficialOwnersOpen && (
                                        <div className="mt-2 text-sm">
                                            {beneficialOwners.map((item, index) => {
                                                const [title, name] = item.split(/\s{2,}/); // Split on two or more spaces
                                                return (
                                                    <>
                                                        <div key={index} className="flex gap-4"> {/* Adjust gap as needed */}
                                                            <span>{title}</span>
                                                            <br />
                                                            <span>{name}</span>
                                                        </div>
                        ...
                        <div className="finalBusinessBtns flex justify-center gap-3 mt-6">
                ...
                <div className="modal fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-75">
                    <div className="bg-white p-6 rounded-lg w-full sm:w-1/3">
                        ...
                        <div className=" flex justify-end mt-4 ">
                            <button onClick={closeModal} className="bg-gray-300 text-black py-2 px-4 rounded mr-2 backBtn9">Cancel</button>
                            <button onClick={saveChanges} className="bg-red-500 text-white py-2 px-4 rounded nextBtn9">Save</button>
                        </div>
                    </div>
                </div>
            )}
